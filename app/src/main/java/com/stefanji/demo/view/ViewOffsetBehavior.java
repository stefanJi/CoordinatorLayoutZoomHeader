...
public class ViewOffsetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    @Nullable
    private OnOffsetChange onOffsetChange = null;

    public void setOnOffsetChange(OnOffsetChange onOffsetChange) {
        Log.d("AAA", "setOffchange");
    ...
    public boolean setTopAndBottomOffset(int offset) {
        if (viewOffsetHelper != null) {
            if (onOffsetChange != null) {
                onOffsetChange.onTopAndBottomOffsetChange(offset);
            }
    ...
    public interface OnOffsetChange {
        void onTopAndBottomOffsetChange(int offset);
    }
}
